...
import org.jiemamy.test.H2DatabaseTest;
import org.jiemamy.test.TestModelBuilders;
import org.jiemamy.utils.DbCleaner;
import org.jiemamy.utils.sql.SqlExecutor;

/**
 * {@link H2Dialect}と実DBの結合テスト。
 * 
 * @version $Id$
 * @author daisuke
 */
public class MySqlDatabaseIntegrationTest extends H2DatabaseTest {
	...
	public void test02_clean() throws Exception {
		...
		// export
		File outFile = new File("target/testresult/H2DatabaseTest_test02.sql");
		...
		new SqlExporter().exportModel(TestModelBuilders.EMP_DEPT.getBuiltModel(H2Dialect.class.getName()), config);
	...
	public void test03_view() throws Exception {
		...
		meta.setDialectClassName(H2Dialect.class.getName());
